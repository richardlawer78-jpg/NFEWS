 ...
 if (active && payload && payload.length) {
   return (
     <div className="weather-tooltip">
       ...
       {payload[1] && <p style={{ color: '#f59e0b' }}>🌡️ Temp: <strong>{payload[1]?.value}°C</strong></p>}
     </div>
   );
 }
 return null;
             ...
             <div className="weather-forecast-grid">
               {weather.forecast.map((f, i) => (
                 <div key={i} className="forecast-item">
                   ...
                   <div className="forecast-icon"><WeatherIcon description={f.description} /></div>
